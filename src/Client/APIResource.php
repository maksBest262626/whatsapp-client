...
use Maksb\WhatsappClient\Client\Credentials\Handler\HandlerInterface;
...
class APIResource implements ClientAwareInterface
{
    ...
    public function get($id, array $query = [], array $headers = [], bool $jsonResponse = true, bool $uriOverride = false)
    {
        ...
        // This is a necessary hack if you want to fetch a totally different URL but use Maksb\WhatsappClient Auth
        if ($uriOverride) {
            $uri = $id;
        }
