...
use Maksb\WhatsappClient\Client\ClientAwareInterface;
use Maksb\WhatsappClient\Client\ClientAwareTrait;
use Maksb\WhatsappClient\Client\Exception as ClientException;
use Maksb\WhatsappClient\Entity\Filter\EmptyFilter;
use Maksb\WhatsappClient\Entity\Filter\FilterInterface;
...
class IterableAPICollection implements ClientAwareInterface, Iterator, Countable
{
    ...
    public function current()
    {
        ...
        return $this->hydrateEntity($this->getResourceRoot()[$this->current]);
    }
    ...
    protected function getException(ResponseInterface $response)
    {
        ...
        if ($status >= 400 && $status < 500) {
            $e = new ClientException\Exception($errorTitle, $status);
